...
EXPECTED=['res1_chain', 'res1_number', 'res1_name', 'res2_chain', 'res2_number', 'res2_name', 'interaction_type', 'weight']
def main():
    ...
    write_csv(df[EXPECTED], Path(a.run_dir)/'psn/ring_edges.csv', EXPECTED)
